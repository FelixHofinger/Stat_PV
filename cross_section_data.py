...
class Cross_Section_Data:
    ...
    def calc_cross_veh_sum(self, data_y1, data_y2):
        ...
        temp_data['Differenz_percentage'] = temp_data['DTVMF_y'] - temp_data['DTVMF_x']#(temp_data('DTVMF_y')+1)
        temp_data['Differenz_percentage'] = temp_data['Differenz_percentage'] / temp_data['DTVMF_x'] * 100
        ...
        if weekday == 'Montag-Freitag':
            if agg_intervall == 'Monatlich':
                for no1, month in enumerate(month_li):
                    ...
                    car_sum_y1, car_sum_y2, car_diff_per = self.calc_cross_veh_sum(car_data_y1,car_data_y2)
                    ...
                    hgv_sum_y1, hgv_sum_y2, hgv_diff_per = self.calc_cross_veh_sum(hgv_data_y1, hgv_data_y2)
